this application is meant to simulate what an investement banker will do to create a comps analysis, we use a fundamentalist approach (not pure comparables).
